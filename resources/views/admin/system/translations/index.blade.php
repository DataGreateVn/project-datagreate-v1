...
<div class="p-4 sm:p-6 space-y-4">
    ...
    {{-- DATA TABLE dùng chung + row tuỳ biến --}}
    <x-ui.datatable
        :rows="$rows"
        :columns="[
            ['key'=>'locale',    'label'=>'Locale',    'class'=>'text-left w-[90px]'],
            ['key'=>'namespace', 'label'=>'Namespace', 'class'=>'text-left w-[160px]'],
            ['key'=>'group',     'label'=>'Group',     'class'=>'text-left w-[160px]'],
            ['key'=>'key',       'label'=>'Key',       'class'=>'text-left min-w-[260px]'],
            ['key'=>'value',     'label'=>'Value',     'class'=>'text-left min-w-[340px]'],
            ['key'=>'_actions',  'label'=>'Actions',   'class'=>'text-right w-[140px]'],
        ]"
